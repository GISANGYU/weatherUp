...
const SI = {
  ...
  kakaotalk:
    'M12 3C6.477 3 2 6.925 2 11.77c0 2.95 1.738 5.558 4.42 7.24L5.5 22l3.64-2.02C10.2 20.3 11.09 20.54 12 20.54c5.523 0 10-3.925 10-8.77S17.523 3 12 3z',
  github:
...
const SOCIAL = [
  ...
  },
  {
    name: 'facebook',
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=100005894472118&locale=ko_KR',
  },
  {
    name: 'kakaotalk',
    label: 'KakaoTalk',
  ...
  },
  {
    name: 'github',
    label: 'GitHub',
    href: 'https://github.com/GISANGYU',
  },
];
              ...
              if (copyText) {
                ...
                return (
                  <a
                    ...
                    title={copied ? `복사됨 ✓  ${copyText}` : `클릭하여 카카오톡 ID 복사: ${copyText}`}
                  >
                    <SvgIcon name={name} />
                  </a>
                );
